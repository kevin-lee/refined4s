...
object autoSpec extends Properties {
  ...
  override def tests: List[Test] = List(
    ...
    //
    property("test Render[MyNum] (Newtype)", testRenderMyNum),
    //
    property("test Render[MyStr] (Refined)", testRenderMyStr),
  )
