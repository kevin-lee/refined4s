...
trait numericSpec {
  ...
  protected val numericTypeClasses: refined4s.modules.pureconfig.derivation.types.numeric
...
object numericSpec extends Properties, numericSpec {
  ...
  override protected object numericTypeClasses extends refined4s.modules.pureconfig.derivation.types.numeric
